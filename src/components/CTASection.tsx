      ...
      <div className="container mx-auto px-4 relative z-10 pt-24 md:pt-32">
        ...
        >
          ...
          >
            <Button
              size="lg"
              className="bg-accent hover:bg-accent/90 text-foreground font-bold text-base md:text-xl w-full px-0 py-6 md:px-12 md:py-8 rounded-full shadow-2xl hover:shadow-accent/50 transition-all duration-300 hover:scale-105 cta-pulse text-center"
              onClick={() => {
